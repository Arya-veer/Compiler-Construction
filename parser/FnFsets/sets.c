   ...
   short int rule17[] = {1,SQBC_TOKEN}; 
    ...
    short int rule67[] = {7, NUM_TOKEN, RNUM_TOKEN, TRUE_BOOL, FALSE_BOOL, IDENTIFIER_TOKEN,PLUS_OPERATOR,MINUS_OPERATOR};
    short int rule68[] = {1, COMMA_OPERATOR};
    short int rule69[] = {1,SEMICOL_OPERATOR};
    short int rule70[] = {1,SQBO_TOKEN};
    short int rule71[] = {1,USE_KEYWORD}; 
    short int rule72[] = {1,IDENTIFIER_TOKEN}; 
    short int rule73[] = {1,COMMA_OPERATOR}; 
    short int rule74[] = {2,SQBC_TOKEN,COLON_OPERATOR}; 
    short int rule75[] = {8,IDENTIFIER_TOKEN,BO_TOKEN,NUM_TOKEN,RNUM_TOKEN,TRUE_BOOL,FALSE_BOOL,PLUS_OPERATOR,MINUS_OPERATOR}; 
    ...
    short int rule82[] = {8,IDENTIFIER_TOKEN,BO_TOKEN,NUM_TOKEN,RNUM_TOKEN,TRUE_BOOL,FALSE_BOOL,PLUS_OPERATOR,MINUS_OPERATOR};
    short int rule83[] = {2,AND_OPERATOR,OR_OPERATOR};
    short int rule84[] = {2,SEMICOL_OPERATOR,BC_TOKEN};
    short int rule85[] = {8,IDENTIFIER_TOKEN,BO_TOKEN,NUM_TOKEN,RNUM_TOKEN,TRUE_BOOL,FALSE_BOOL,PLUS_OPERATOR,MINUS_OPERATOR};
    short int rule86[] = {6,LT_OPERATOR,LE_OPERATOR,GT_OPERATOR,GE_OPERATOR,EQ_OPERATOR,NE_OPERATOR};
    short int rule87[] = {4,AND_OPERATOR,OR_OPERATOR,SEMICOL_OPERATOR,BC_TOKEN};
    short int rule88[] = {8,IDENTIFIER_TOKEN,BO_TOKEN,NUM_TOKEN,RNUM_TOKEN,TRUE_BOOL,FALSE_BOOL,PLUS_OPERATOR,MINUS_OPERATOR}; 
    ...
    short int rule95[] = {8,IDENTIFIER_TOKEN,BO_TOKEN,NUM_TOKEN,RNUM_TOKEN,TRUE_BOOL,FALSE_BOOL,PLUS_OPERATOR,MINUS_OPERATOR};; 
    ...
    short int rule99[] = {7,IDENTIFIER_TOKEN,NUM_TOKEN,RNUM_TOKEN,PLUS_OPERATOR,MINUS_OPERATOR,TRUE_BOOL,FALSE_BOOL}; 
