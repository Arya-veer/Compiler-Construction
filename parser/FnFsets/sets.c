    ...
    short int rule62[] = {2, COMMA_OPERATOR, SEMICOL_OPERATOR};
    ...
    short int rule85[] = {6,LT_OPERATOR,LE_OPERATOR,GT_OPERATOR,GE_OPERATOR,EQ_OPERATOR,NE_OPERATOR}; 
    short int rule86[] = {4,AND_OPERATOR,OR_OPERATOR,SEMICOL_OPERATOR,BC_TOKEN}; 
    short int rule87[] = {4,IDENTIFIER_TOKEN,BO_TOKEN,NUM_TOKEN,RNUM_TOKEN}; 
    short int rule88[] = {2,PLUS_OPERATOR,MINUS_OPERATOR}; 
    short int rule89[] = {10,BC_TOKEN,LT_OPERATOR,LE_OPERATOR,GE_OPERATOR,GT_OPERATOR,EQ_OPERATOR,NE_OPERATOR,AND_OPERATOR,OR_OPERATOR,SEMICOL_OPERATOR}; 
    short int rule90[] = {1,PLUS_OPERATOR}; 
    short int rule91[] = {1,MINUS_OPERATOR}; 
    short int rule92[] = {1,MUL_OPERATOR}; 
    short int rule93[] = {1,DIV_OPERATOR}; 
    short int rule94[] = {4,IDENTIFIER_TOKEN,BO_TOKEN,NUM_TOKEN,RNUM_TOKEN}; 
    short int rule95[] = {2,MUL_OPERATOR,DIV_OPERATOR}; 
    short int rule96[] = {12,PLUS_OPERATOR,MINUS_OPERATOR,SEMICOL_OPERATOR,BC_TOKEN,LT_OPERATOR,LE_OPERATOR,GT_OPERATOR,GE_OPERATOR,EQ_OPERATOR,NE_OPERATOR,AND_OPERATOR,OR_OPERATOR}; 
    short int rule97[] = {1,BO_TOKEN}; 
    short int rule98[] = {3,IDENTIFIER_TOKEN,NUM_TOKEN,RNUM_TOKEN}; 
    short int rule99[] = {6,PLUS_OPERATOR,MINUS_OPERATOR,BO_TOKEN,IDENTIFIER_TOKEN,NUM_TOKEN,RNUM_TOKEN}; 
    short int rule100[] = {2,PLUS_OPERATOR,MINUS_OPERATOR}; 
    short int rule101[] = {2,SQBC_TOKEN,BC_TOKEN}; 
    short int rule102[] = {6,PLUS_OPERATOR,MINUS_OPERATOR,BO_TOKEN,IDENTIFIER_TOKEN,NUM_TOKEN,RNUM_TOKEN}; 
    short int rule103[] = {2,MUL_OPERATOR,DIV_OPERATOR}; 
    short int rule104[] = {4,SQBC_TOKEN,PLUS_OPERATOR,MINUS_OPERATOR,BC_TOKEN}; 
    short int rule105[] = {6,PLUS_OPERATOR,MINUS_OPERATOR,BO_TOKEN,IDENTIFIER_TOKEN,NUM_TOKEN,RNUM_TOKEN}; 
    short int rule106[] = {1,BO_TOKEN}; 
    short int rule107[] = {1,IDENTIFIER_TOKEN}; 
    short int rule108[] = {1,NUM_TOKEN}; 
    short int rule109[] = {1,RNUM_TOKEN}; 
    short int rule110[] = {1,AND_OPERATOR}; 
    short int rule111[] = {1,OR_OPERATOR}; 
    short int rule112[] = {1,LT_OPERATOR}; 
    short int rule113[] = {1,LE_OPERATOR}; 
    short int rule114[] = {1,GT_OPERATOR}; 
    short int rule115[] = {1,GE_OPERATOR}; 
    short int rule116[] = {1,EQ_OPERATOR}; 
    short int rule117[] = {1,NE_OPERATOR}; 
    short int rule118[] = {1,DECLARE_KEYWORD}; 
    short int rule119[] = {1,SWITCH_KEYWORD}; 
    short int rule120[] = {1,CASE_KEYWORD}; 
    short int rule121[] = {1,CASE_KEYWORD}; 
    short int rule122[] = {2,DEFAULT_KEYWORD,END_KEYWORD}; 
    short int rule123[] = {1,NUM_TOKEN}; 
    short int rule124[] = {2,TRUE_BOOL, FALSE_BOOL}; 
    short int rule125[] = {1,DEFAULT_KEYWORD}; 
    short int rule126[] = {1,END_KEYWORD}; 
    short int rule127[] = {1,FOR_KEYWORD}; 
    short int rule128[] = {1,WHILE_KEYWORD};
